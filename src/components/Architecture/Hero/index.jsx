        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="img-exp">
              <div className="img bg-img" style={{ backgroundImage: "url('arch/img/images-shoeclean-3.webp')" }}></div>
              <div id="circle">
              ...
              <div className="rotate-exp">
                ...
                <h6>Only<br />ordered</h6>
              </div>
            </div>
          </div>
          <div className="col-lg-6 valign">
            <div className="content">
              <h6 className="fz-12 text-u ls4 yellow-green-color mb-10">Information</h6>
